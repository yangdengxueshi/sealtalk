...
public class ContactDetailActivity extends RongBaseNoActionbarActivity {
    ...
    private void initView() {
        mTargetPortrait = findViewById(R.id.target_portrait);
        mTargetName = findViewById(R.id.target_name);
        mArrow = findViewById(R.id.target_group_arrow);
        mContactName = findViewById(R.id.contact_name);
        mMessage = findViewById(R.id.message);
        mSend = findViewById(R.id.send);
        mCancel = findViewById(R.id.cancel);
        mViewAnimator = findViewById(R.id.va_detail);
    ...
    private static class GridAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                viewHolder.portrait = convertView.findViewById(R.id.iv_avatar);
