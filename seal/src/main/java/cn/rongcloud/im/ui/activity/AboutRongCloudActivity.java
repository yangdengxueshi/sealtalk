...
public class AboutRongCloudActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout mUpdateLog = findViewById(R.id.rl_update_log);
        RelativeLayout mFunctionIntroduce = findViewById(R.id.rl_function_introduce);
        RelativeLayout mRongCloudWeb = findViewById(R.id.rl_rongcloud_web);
        mNewVersionView = findViewById(R.id.about_sealtalk_version);
        TextView mSDKVersion = findViewById(R.id.sdk_version_text);
        RelativeLayout mVersionItem = findViewById(R.id.rl_version);
        TextView version = findViewById(R.id.sealtalk_version);
        RelativeLayout mCloseDebug = findViewById(R.id.close_debug);
        RelativeLayout mStartDebug = findViewById(R.id.start_debug);
        RelativeLayout mSetOnlineStatus = findViewById(R.id.set_online_status);
