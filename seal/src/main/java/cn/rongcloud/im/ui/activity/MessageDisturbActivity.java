...
public class MessageDisturbActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        SwitchButton mSwitchButton = findViewById(R.id.disturb_switch);
        mIsShowSetting = findViewById(R.id.is_show_notification);
        RelativeLayout mStartNotification = findViewById(R.id.start_notification);
        RelativeLayout mEndStartNotification = findViewById(R.id.end_notification);
        mStartTimeNotification = findViewById(R.id.start_time_notification);
        mEndTimeNotification = findViewById(R.id.end_time_notification);
