...
public class PrivateChatDetailActivity extends BaseActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private void initView() {
        LinearLayout cleanMessage = findViewById(R.id.clean_friend);
        mImageView = findViewById(R.id.friend_header);
        ...
        messageTop = findViewById(R.id.sw_freind_top);
        messageNotification = findViewById(R.id.sw_friend_notfaction);
        friendName = findViewById(R.id.friend_name);
        mSearchChattingRecordsLinearLayout = findViewById(R.id.ac_ll_search_messages);
