...
public class DisturbActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initView() {
        mCloseNotification = findViewById(R.id.close_notification);
        mStartNotification = findViewById(R.id.start_notification);
        mStartTimeNotification = findViewById(R.id.start_time_notification);
        mEndNotification = findViewById(R.id.end_notification);
        mEndTimeNotification = findViewById(R.id.end_time_notification);
        mNotificationCheckBox = findViewById(R.id.notification_checkbox);
