...
public class DiscussionDetailActivity extends BaseActivity implements CompoundButton.OnCheckedChangeListener, View.OnClickListener {
    ...
    private void initView() {
        memberSize = findViewById(R.id.discu_member_size);
        mGridView = findViewById(R.id.discu_gridview);
        discussionTop = findViewById(R.id.sw_discu_top);
        discussionNof = findViewById(R.id.sw_discu_notfaction);
        LinearLayout discussionClean = findViewById(R.id.discu_clean);
        Button deleteDiscussion = findViewById(R.id.discu_quit);
    ...
    private class GridAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            ImageView badge_delete = convertView.findViewById(R.id.badge_delete);
