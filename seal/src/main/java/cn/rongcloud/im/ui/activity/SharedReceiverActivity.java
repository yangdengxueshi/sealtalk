...
public class SharedReceiverActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        shareListView = findViewById(R.id.share_listview);
                ...
                if (newConversationsList != null) {
                    ...
                    ok.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            LoadDialog.show(mContext);
                            final EditText say = window.findViewById(R.id.share_say);
    ...
    class ShareAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                ...
                holder.mImageView = convertView.findViewById(R.id.share_icon);
                holder.title = convertView.findViewById(R.id.share_name);
