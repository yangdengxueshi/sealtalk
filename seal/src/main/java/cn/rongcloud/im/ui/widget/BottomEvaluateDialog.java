...
public class BottomEvaluateDialog extends Dialog {
    ...
    private void initScrollView() {
        evaluateScrollView = findViewById(R.id.scrollview_evaluate);
    }

    private void initProblemLabels() {
        layout_problems = findViewById(R.id.ll_problems);
        layout_problems.setVisibility(View.GONE);
        problems_title = findViewById(R.id.tv_problem_title);
        layout_problem_labels = findViewById(R.id.ll_problem_tables);
    ...
    private void initSuggestionView() {
        editTextSuggestion = findViewById(R.id.edit_suggestion);
    ...
    private void initStarts() {
        int stars = 5;
        final LinearLayout linearLayout = findViewById(R.id.cs_stars);
    ...
    private void initResolveFeedback() {
        layout_resolve_feedback = findViewById(R.id.ll_resolve_feedback);
        ...
        tv_unresolved = findViewById(R.id.tv_unresolved);
