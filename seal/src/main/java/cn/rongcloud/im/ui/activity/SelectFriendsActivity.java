...
public class SelectFriendsActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSelectedFriendsLinearLayout = findViewById(R.id.ll_selected_friends);
    ...
    private void initView() {
        ...
        mListView = findViewById(R.id.dis_friendlistview);
        mNoFriends = findViewById(R.id.dis_show_no_friend);
        SideBar mSidBar = findViewById(R.id.dis_sidrbar);
        dialog = findViewById(R.id.dis_dialog);
                ...
                viewHolder.isSelect.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (mSelectedFriend.contains(friend)) {
                            ...
                            SelectableRoundedImageView asyncImageView = view.findViewById(R.id.iv_selected_friends);
