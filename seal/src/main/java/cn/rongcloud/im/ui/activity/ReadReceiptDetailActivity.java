...
public class ReadReceiptDetailActivity extends BaseActivity {
    ...
    private boolean isReadMember(GroupMember member) {
        if (mMessage != null && mMessage.getReadReceiptInfo() != null
            ...
            return mMessage.getReadReceiptInfo().getRespondUserIdList().containsKey(member.getUserId());
        }
        return false;
    }
    ...
    private void initViews() {
        ...
        mScrollView = this.findViewById(R.id.rc_read_receipt_scroll_view);
        ...
        String formatString;
        String content;
        tv_underline_page1 = findViewById(R.id.underline_page1);
        tv_underline_page2 = findViewById(R.id.underline_page2);
        tv_title_read = findViewById(R.id.title_read);
        ...
        tv_title_unread = findViewById(R.id.title_unread);
        ...
        mPromtReadText = readView.findViewById(R.id.promt_text);
        mPromtUnreadText = unreadView.findViewById(R.id.promt_text);
        mImageExpand = findViewById(R.id.ic_iv_expand);
    ...
    private void initDataView() { //初始化需要群组信息返回之后的数据
        ...
        mGridRead = readView.findViewById(R.id.grid_view);
        mGridUnread = unreadView.findViewById(R.id.grid_view);
        ...
        LinearLayout layout_solid = findViewById(R.id.rc_read_receipt_solid_area);
    ...
    private class GridAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            SelectableRoundedImageView iv_avatar = convertView.findViewById(R.id.iv_avatar);
