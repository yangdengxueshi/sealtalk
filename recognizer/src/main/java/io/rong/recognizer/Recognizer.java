...
public class Recognizer extends RelativeLayout implements RecognizerListener {
    ...
    private void initViews() {
        ...
        imgMic = recognizerContainer.findViewById(R.id.img_mic);

        TextView tvClear = recognizerContainer.findViewById(R.id.btn_clear);
        ...
        rlBottom = recognizerContainer.findViewById(R.id.rl_bottom);
